...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterButton = (TextView) findViewById(R.id.register_action);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            JSONObject response = restCall.executeCall(Urls.HOST + "/user/login", HttpRequestMethod.GET);
            ...
            if(response != null) {
                try {
                    if (HttpURLConnection.HTTP_OK == Integer.valueOf(response.get("responseCode").toString())) {
                        ...
                        SharedPreferencesService.saveLoggedUserEmail(getApplicationContext(), email);
                        return true;
                    }
